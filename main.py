...
def menu_admin():
    while True:
        ...
        print("6. Agregar piloto")
        print("7. Eliminar piloto")
        print()
        print("[Gestión de equipos]")
        print("8. Crear equipo")
        print("9. Modificar equipo")
        print("10. Eliminar equipo")
        print()
        print("[Gestión de circuitos]")
        print("11. Crear circuito")
        print("12. Modificar circuito")
        print("13. Eliminar circuito")
        print()
        print("[Gestión de tiempos]")
        print("14. Registrar tiempo nuevo")
        print("15. Modificar tiempo existente")
        print("16. Eliminar tiempo de un piloto")
        print("17. Eliminar todos los tiempos de un piloto")
        print()
